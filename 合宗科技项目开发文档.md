...
~~~xml
 <select id="getUserByMessage" resultType="com.hezong.pojo.User">
...
~~~xml
          <!-- 一对多关系映射-->
    <resultMap id="menuMap" type="com.hezong.pojo.MainMenu">
        <id column="id" property="id"></id>
        <result column="title" property="title"></result>
        <result column="path" property="path"></result>
        <collection property="sList" ofType="com.hezong.pojo.SubMenu">
...
~~~xml
 <!--获取所有用户  pageStart:从哪里开始展示  pageSize：页面展示条数 -->
    <select id="getAllUser" resultType="com.hezong.pojo.User">
